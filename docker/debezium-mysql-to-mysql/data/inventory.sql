...
INSERT INTO customers(first_name,last_name,email,created_at, password)
  VALUES ('Edward','Walker','ed@walker.com',SYSDATETIME(), HashBytes('sha1', 'secret1'));
INSERT INTO customers(first_name,last_name,email,created_at, password)
  VALUES ('Anne','Kretchmar','annek@noanswer.org',SYSDATETIME(), HashBytes('sha1', 'secret2'));
INSERT INTO customers(first_name,last_name,email,created_at, password)
    VALUES ('Sally','Thomas','sally.thomas@acme.com',SYSDATETIME(), HashBytes('sha1', 'secret3'));
INSERT INTO customers(first_name,last_name,email,created_at, password)
    VALUES ('George','Bailey','gbailey@foobar.com',SYSDATETIME(), HashBytes('sha1', 'secret4'));
